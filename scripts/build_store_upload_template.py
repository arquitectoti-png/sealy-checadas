...
def main():
    ...
    examples = [
        ["Coppel", "Hermosillo Centro", "Direccion completa de la tienda", 29.072967, -110.955919, 50, "SONORA"],
        ["Suburbia", "Monterrey Centro", "Direccion completa de la tienda", 25.686614, -100.316113, 50, "CENTRO"],
        ["Coppel", "Tijuana Centro", "Direccion completa de la tienda", 32.514947, -117.038247, 50, "BAJA"],
    ]
    comments = {
        ...
        "zona_horaria": "Usa una clave: CENTRO, SONORA, PACIFICO, BAJA o CANCUN. Si se deja vacio, se tomara CENTRO.",
    }
    ...
    validation = DataValidation(
        type="list",
        formula1='"CENTRO,SONORA,PACIFICO,BAJA,CANCUN"',
        allow_blank=True,
    )
    validation.promptTitle = "Zona horaria"
    validation.prompt = "Selecciona: CENTRO, SONORA, PACIFICO, BAJA o CANCUN"
    ...
    for row in catalog.iter_rows(min_row=2, max_row=6, min_col=1, max_col=4):
        for cell in row:
            cell.border = border
