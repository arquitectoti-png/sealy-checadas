...
def main():
    ...
    headers = ["nombre", "email", "numero_empleado", "telefono", "supervisor", "contrasena"]
    examples = [
        ["Promotor 101", "promotor101@sealy.com", "PRO101", "5512340001", "", "Cambiar123!"],
        ["Promotor 102", "promotor102@sealy.com", "PRO102", "5512340002", "Supervisor 1", "Cambiar123!"],
        ["Promotor 103", "promotor103@sealy.com", "PRO103", "5512340003", "supervisor1@sealy.com", "Cambiar123!"],
    ]
    comments = {
    ...
    widths = [30, 32, 20, 18, 28, 18]
    max_rows = 503

    ws.freeze_panes = "A2"
    ws.auto_filter.ref = f"A1:F{max_rows}"
    ...
    for row in catalog.iter_rows(min_row=1, max_row=7, min_col=1, max_col=3):
        for cell in row:
            cell.border = border
